...
stations <- c('ABO','AIG','ALT','BAS','BER','BUS','CDF','CGI','CHA','CHU','CIM',
              'COV','DAV','DIS','DOL','ENG','FAH','FRE','GLA','GSB','GUE','GUT',
              'GVE','HIR','INT','KLO','LUG','LUZ','MAG','MLS','RUE','SAE','SAM',
              'SBE','SBO','SCU','SHA','SIO','SMA','STG','TAE','ULR','VAD','VIS',
              'WAE','WFJ','WYN','ZER')

stations <- c('ABO','AIG','ALT','BAS','BER','BUS','CDF','CGI','CHA','CHU','CIM',
              'COV','DAV','DIS','DOL','ENG','FAH','FRE','GLA','GSB','GUE','GUT',
              'GVE','HIR','INT','KLO','LUG','LUZ','MAG','MLS','MVE','NAP','NEU',
              'OTL','PAY','PIL','PIO','PUY','REH','ROB','RUE','SAE','SAM','SBE',
              'SBO','SCU','SHA','SIO','SMA','STG','TAE','ULR','VAD','VIS','WAE',
              'WFJ','WYN','ZER','ANT','CHD','CHM','GRC','GRH','ELM','MER','RAG',
              'SIA')
...
if(any(all_phase_start_fixed == FALSE, na.rm=T) != TRUE){
  write.csv(all_modelchains_df, paste0(paste(output_base_path,"CH2018/model_application",model_run,sowing_date_determination_method,"combined",sep="/"),"/observations_",model_run ,"_fixed-phase-start",".csv"))
