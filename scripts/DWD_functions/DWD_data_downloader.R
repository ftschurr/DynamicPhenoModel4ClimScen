...
data <- read.table("O:/Projects/KP0030_ftschurr/data/DWD/historic/phenology/PH_Jahresmelder_Landwirtschaft_Kulturpflanze_Winterweizen_1925_2020_hist.txt", header=T, sep=";")
...
# # write.csv(stations_df,"O:/Projects/KP0030_ftschurr/data/DWD/stations_pheno.csv" )
...
stations <- read.csv("O:/Projects/KP0030_ftschurr/data/DWD/stations_pheno.csv")$station_id
stations <- stringr::str_pad(stations, 5,pad="0")
...
# variable_names <- c("precipitation","air_temperature","solar")
variables <- c("KL","ST")
variable_names <- c("kl","solar")
names(variables) <- variable_names
download_path <- "O:/Projects/KP0030_ftschurr/data/DWD/historic/climate/zips"
...
variables <- c("RR","TU","ST")
variables <- c("KL","ST")
base_output_path <- "O:/Projects/KP0030_ftschurr/data/DWD/historic/climate"
granularity <- c("daily")
download_path <- "O:/Projects/KP0030_ftschurr/data/DWD/historic/climate/zips"
